package com.ityouzi.log.aspect;
...
import com.ityouzi.log.enums.BusinessStatus;
import com.ityouzi.log.event.SysOperLogEvent;
...
{
    // 配置织入点
    @Pointcut("@annotation(com.ityouzi.log.annotation.OperLog)")
