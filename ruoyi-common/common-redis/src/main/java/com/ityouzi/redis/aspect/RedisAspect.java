package com.ityouzi.redis.aspect;
...
public class RedisAspect
{
     ...
     */
    @Pointcut("@annotation(com.ityouzi.redis.annotation.RedisCache)")
    public void redisCachePoint()
    {
    }

    @Pointcut("@annotation(com.ityouzi.redis.annotation.RedisEvict)")
